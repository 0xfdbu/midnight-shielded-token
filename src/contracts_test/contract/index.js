...
class _ShieldedSendResult_0 {
  ...
  fromValue(value_0) {
    return {
      change: _descriptor_4.fromValue(value_0),
      sent: _descriptor_2.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_4.toValue(value_0.change).concat(_descriptor_2.toValue(value_0.sent));
  }
}

const _descriptor_5 = new _ShieldedSendResult_0();
...
class _Either_0 {
  alignment() {
    return _descriptor_3.alignment().concat(_descriptor_8.alignment().concat(_descriptor_7.alignment()));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_3.toValue(value_0.is_left).concat(_descriptor_8.toValue(value_0.left).concat(_descriptor_7.toValue(value_0.right)));
  }
}
...
class _QualifiedShieldedCoinInfo_0 {
  alignment() {
    return _descriptor_1.alignment().concat(_descriptor_1.alignment().concat(_descriptor_0.alignment().concat(_descriptor_6.alignment())));
  }
  fromValue(value_0) {
    return {
      nonce: _descriptor_1.fromValue(value_0),
  ...
  toValue(value_0) {
    return _descriptor_1.toValue(value_0.nonce).concat(_descriptor_1.toValue(value_0.color).concat(_descriptor_0.toValue(value_0.value).concat(_descriptor_6.toValue(value_0.mt_index))));
  }
}
...
class _CoinPreimage_0 {
  alignment() {
    return _descriptor_14.alignment().concat(_descriptor_2.alignment().concat(_descriptor_3.alignment().concat(_descriptor_1.alignment())));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_14.toValue(value_0.domain_sep).concat(_descriptor_2.toValue(value_0.info).concat(_descriptor_3.toValue(value_0.dataType).concat(_descriptor_1.toValue(value_0.data))));
  }
}
...
export class Contract {
    ...
    this.circuits = {
      createShieldedToken: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_6.toValue(amount_0).concat(_descriptor_9.toValue(recipient_0)),
            alignment: _descriptor_6.alignment().concat(_descriptor_9.alignment())
          },
          output: undefined,
          publicTranscript: [],
      ...
      transferShielded: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_10.toValue(coin_0).concat(_descriptor_9.toValue(recipient_0).concat(_descriptor_0.toValue(amount_0))),
            alignment: _descriptor_10.alignment().concat(_descriptor_9.alignment().concat(_descriptor_0.alignment()))
          },
          output: undefined,
          publicTranscript: [],
          privateTranscriptOutputs: []
      ...
      burnShieldedToken: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(coin_0).concat(_descriptor_0.toValue(amount_0)),
  ...
  _createShieldedToken_0(context, partialProofData, amount_0, recipient_0) {
    ...
    const tmp_0 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('Token.compact line 20 char 19: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
  ...
  _mintAndSend_0(context, partialProofData, amount_0, recipient_0) {
    ...
    const tmp_0 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('Token.compact line 37 char 19: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
                  })(_descriptor_6.fromValue(__compactRuntime.queryLedgerState(context,
                                                                               partialProofData,
  ...
  _burnShieldedToken_0(context, partialProofData, coin_0, amount_0) {
    ...
    const tmp_0 = ((t1) => {
                    if (t1 > 340282366920938463463374607431768211455n) {
                      throw new __compactRuntime.CompactError('Token.compact line 53 char 19: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 340282366920938463463374607431768211455');
                    }
                    return t1;
